...
namespace DeviantAnomalyRedemptionStuff.Items.Weapons.Magic
{
    ...
    public class XenomiteCrystalBomb4b : ModItem
    {
        public float Charge;
        ...
        public override void AddRecipes()
        {
            ...
            if (RedeMod != null)
            {
                recipe.AddRecipeGroup("DeviantAnomalyRedemptionStuff:tier 3/pink Xenomite Crystal Bomb weapon");
