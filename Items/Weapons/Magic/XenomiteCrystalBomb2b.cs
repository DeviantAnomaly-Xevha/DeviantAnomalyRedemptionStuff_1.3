...
namespace DeviantAnomalyRedemptionStuff.Items.Weapons.Magic
{
    ...
    public class XenomiteCrystalBomb2b : ModItem
    {
        public float Charge;
