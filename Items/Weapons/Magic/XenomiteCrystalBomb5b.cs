...
namespace DeviantAnomalyRedemptionStuff.Items.Weapons.Magic
{
    ...
    public class XenomiteCrystalBomb5b : ModItem
    {
        public float Charge;
