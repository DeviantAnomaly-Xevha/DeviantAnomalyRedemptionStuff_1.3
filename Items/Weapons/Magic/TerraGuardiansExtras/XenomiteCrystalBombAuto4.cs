...
{
    public class XenomiteCrystalBombAuto4 : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            if (RedeMod != null)
            {
                ...
                if (RedeMod != null)
                {
                    recipe.AddIngredient(ModLoader.GetMod("DeviantAnomalyRedemptionStuff").ItemType("XenomiteCrystalBombAuto3"));
                    recipe.AddIngredient(RedeMod.ItemType("Xenomite"), 12);
                    recipe.AddIngredient(RedeMod.ItemType("StarliteBar"), 7);
                    recipe.AddRecipeGroup("Redemption:BioweaponBile", 7);
                    recipe.AddIngredient(RedeMod.ItemType("Biohazard"), 7);
