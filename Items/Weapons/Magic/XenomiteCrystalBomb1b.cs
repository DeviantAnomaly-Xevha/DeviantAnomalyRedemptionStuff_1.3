...
namespace DeviantAnomalyRedemptionStuff.Items.Weapons.Magic
{
    ...
    public class XenomiteCrystalBomb1b : ModItem
    {
        public float Charge;
        ...
        public override void AddRecipes()
        {
            ...
            if (RedeMod != null)
            {
                recipe.AddIngredient(RedeMod.ItemType("XenomiteShard"), 7);
                recipe.AddIngredient(ItemID.MeteoriteBar, 7);//Meteorite Bars
