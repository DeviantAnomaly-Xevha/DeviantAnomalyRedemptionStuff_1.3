...
{
	public class XenomiteClaw4b : ModItem
	{
		...
		public override void SetStaticDefaults() 
		{
			...
			if(RedeMod != null)
			Tooltip.SetDefault("[i:" + RedeMod.ItemType("Bioweapon") + "]Large, deadly... and infectious!\nFor those who prefer a smoother look.\nHolding this may infect you...");
			else {
    ...
    item.glowMask = customGlowMask;
		...
		public override void AddRecipes() 
		{
			...
			recipe.AddIngredient(RedeMod.ItemType("Biohazard"), 5);
