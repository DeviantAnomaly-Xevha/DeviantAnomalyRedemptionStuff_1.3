    ...
    public class X2XenomiteCrystalBomb_Proj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if (target.defDefense >= projectile.damage * .75 || target.takenDamageMultiplier <= .25)
            {
                ...
                Projectile.NewProjectile(projectile.Center.X - 2, projectile.Center.Y, -1f, -1f, ModContent.ProjectileType<X2XenomiteCrystalBombLeftHalf_Proj>(), projectile.damage / 2, 0, projectile.owner);

                Projectile.NewProjectile(projectile.Center.X + 2, projectile.Center.Y, 1f, -1f, ModContent.ProjectileType<X2XenomiteCrystalBombRightHalf_Proj>(), projectile.damage / 2, 0, projectile.owner);
            }
