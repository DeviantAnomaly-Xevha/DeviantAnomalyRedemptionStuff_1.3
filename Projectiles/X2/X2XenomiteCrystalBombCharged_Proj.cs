...
namespace DeviantAnomalyRedemptionStuff.Projectiles.X2
{
    public class X2XenomiteCrystalBombCharged_Proj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(Main.projectile[a].Center.X - 2, Main.projectile[a].Center.Y - 9, -1f, 1f, ModContent.ProjectileType<X2XenomiteCrystalBombChargedLeftHalf_Proj>(), projectile.damage, 0, projectile.owner);

            Projectile.NewProjectile(Main.projectile[a].Center.X + 2, Main.projectile[a].Center.Y - 9, 1f, 1f, ModContent.ProjectileType<X2XenomiteCrystalBombChargedRightHalf_Proj>(), projectile.damage, 0, projectile.owner);
        ...
        {
            int a = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, ModContent.ProjectileType<X2XenomiteCrystalBombChargedPillarSpawner_Proj>(), projectile.damage / 2, 0, projectile.owner);
